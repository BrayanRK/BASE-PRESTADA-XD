...
const getSource = (mctx: types.MessageContext): types.MessageContext => mctx.quoted || mctx

const participantJid = (participant: any): string => {
...
const command: types.Command = {
  ...
  execute: async (wss, { mctx, args, groupMetadata, usedPrefix, commandName, bot }) => {
    ...
    if (textFromMessage) await rememberGeneratedTagText(botJid, mctx.chat.jid, textFromMessage)
