...
type CoinSide = "cara" | "cruz"

const sideMap: Record<string, CoinSide> = {
  cara: "cara",
  caras: "cara",
  head: "cara",
  heads: "cara",
...
const getSide = (value?: string): CoinSide | null => sideMap[String(value ?? "").trim().toLowerCase()] || null
...
const command: types.Command = {
  ...
  execute: async (_, { mctx, args, group, bot, usedPrefix }) => {
    ...
    const result: CoinSide = Math.random() < 0.5 ? "cara" : "cruz"
