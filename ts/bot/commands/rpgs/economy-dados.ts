...
type BetMode =
  | { kind: "number"; value: number; payoutMultiplier: 5 }
  | { kind: "parity"; value: "par" | "impar"; payoutMultiplier: 2 }
  | { kind: "range"; value: "alto" | "bajo"; payoutMultiplier: 2 }

const parityMap: Record<string, "par" | "impar"> = { par: "par", pares: "par", even: "par", impar: "impar", impares: "impar", odd: "impar" }
const rangeMap: Record<string, "alto" | "bajo"> = { alto: "alto", high: "alto", mayor: "alto", bajo: "bajo", low: "bajo", menor: "bajo" }

const parseMode = (raw?: string): BetMode | null => {
