...
const defaultData: DatabaseJSON = {
  users: {},
  chats: {},
  stats: {},
  msgs: {},
...
export class JSONBackup {
  private static dbPath = "database.json"
  private static data: DatabaseJSON = defaultData
  ...
  static async backupUser(userJid: string, userData: any) {
    try {
      this.read()
  ...
  static async getUserFromJSON(userJid: string) {
    try {
      this.read()
  ...
  static async deleteUserFromJSON(userJid: string) {
    try {
      this.read()
  ...
  static async saveToJSON(key: keyof DatabaseJSON, data: any) {
    try {
      this.read()
  ...
  static async getFromJSON(key: keyof DatabaseJSON) {
    try {
      this.read()
  ...
  static async syncAllUsers() {
    ...
    try {
      ...
      this.write()
      console.log(
        `[JSONBackup] Sincronizados ${allUsers.length} usuarios, ${allGroups.length} grupos, ${allBots.length} bots`,
      )
    } catch (error) {
