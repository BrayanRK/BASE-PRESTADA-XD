...
export const inferTagDesignFromText = (rawTemplate) => {
...
export const buildTagDesignHelp = (prefix) => {
    return [
        "╭─〔 ✦ SETTAG ✦ 〕",
