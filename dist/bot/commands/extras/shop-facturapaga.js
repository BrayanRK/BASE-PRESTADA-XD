import { buildInvoiceCaption, guardShopCommand, invoiceMatches, loadInvoiceDb, normalizeNumber, saveInvoiceDb, shopHeader, toUserJid, } from "../../../libs/shop.js";
const command = {
    name: "facturapaga",
    ...
    execute: async (wss, ctx) => {
        ...
        const targets = Array.from(new Set([ctx.mctx.chat.jid, toUserJid(invoice.cliente.numero), toUserJid(invoice.vendedor.numero)].filter(Boolean)));
