import { formatNumber, getDisplayName, getRuntimeGacha, sendText, gachaHeader, gachaHint, gachaPageFooter, parsePageArgs, } from "../../../libs/gacha.js";
export default {
    name: "haremshop",
    ...
    execute: async (wss, { mctx, args, bot, group, usedPrefix }) => {
        try {
            ...
            const text = `${gachaHeader("Tienda Gacha")}\n\n` +
                `▢ Ventas » *${sales.total}*\n` +
