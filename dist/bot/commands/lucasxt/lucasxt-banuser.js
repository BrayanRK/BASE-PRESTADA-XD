...
import { banBotUserMany, getBotScopeJids, getTargetJids, refreshGroupMetadata, resolveGroupActionTarget, sameIdentity, } from "../../../libs/lucasxt-moderation.js";
export default {
    name: "banuser",
    alias: ["banbot"],
    ...
    execute: async (wss, { mctx, args, bot, groupMetadata }) => {
        ...
        for (const botJid of getBotScopeJids(bot, mctx))
            await banBotUserMany(botJid, identities);
