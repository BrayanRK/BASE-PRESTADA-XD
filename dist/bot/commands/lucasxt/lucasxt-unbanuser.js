import { getBotScopeJids, getTargetJids, refreshGroupMetadata, resolveGroupActionTarget, unbanBotUserMany, } from "../../../libs/lucasxt-moderation.js";
export default {
    name: "unbanuser",
    alias: ["unbanbot"],
    ...
    execute: async (wss, { mctx, args, bot, groupMetadata }) => {
        ...
        for (const botJid of getBotScopeJids(bot, mctx))
            await unbanBotUserMany(botJid, identities);
