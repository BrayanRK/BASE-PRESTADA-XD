...
const formatAiReply = (botName, answer) => {
...
const command = {
    ...
    execute: async (wss, { mctx, args, bot, usedPrefix, commandName }) => {
        ...
        const botName = cleanText(bot.name || bot.username || (String(bot.bot_type) === "main" ? getRuntimeBotName() : "") || mctx.me.name, "Bot");
        const ownerName = cleanText(bot.owner_name || (String(bot.bot_type) === "main" ? getRuntimeOwnerName() : "") || "mi owner", "mi owner");
        if (!question) {
