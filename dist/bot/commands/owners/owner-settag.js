...
import { buildTagDesignHelp, inferTagDesignFromText, loadTagDesign, materializeEscapes, renderTagDesign, resetTagDesign, saveTagDesign, } from "../../../libs/tag-design.js";
...
const okBox = (lines) => ["╭─〔 ✦ SETTAG ✦ 〕", ...lines.map((line) => `│ ${line}`), "╰────────────"].join("\n");
